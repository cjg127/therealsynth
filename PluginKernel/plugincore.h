...
private:
	...
	int eg1Mode = 0;
	enum class eg1ModeEnum { kADSR,kAHDSR,kAHR };	// to compare: if(compareEnumToInt(eg1ModeEnum::kADSR, eg1Mode)) etc... 

	int eg1Retrigger = 0;
	enum class eg1RetriggerEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(eg1RetriggerEnum::SWITCH_OFF, eg1Retrigger)) etc... 
